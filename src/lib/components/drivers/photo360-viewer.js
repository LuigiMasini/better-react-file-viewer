...
export default class extends Component {
  ...
  render() {
	  //with width 100% & height 100% there is overflow
    return (
	   <>
	   <HelpMsgContainer><HelpMsg>Click and drag to rotate the view</HelpMsg></HelpMsgContainer>
      <div
        id="360-photo"
	style={{height: '97%',width: '99%'}}
...
const HelpMsg = styled.p`
	...
	font-weight:bold;
`
const HelpMsgContainer = styled.div`
	margin:0;
	height:3%;
	text-align:center;
`
